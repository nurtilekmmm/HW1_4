...
public class Main {
    ...
    public static void medicHeal() {
        ...
        if (needHeal != -1) {
            heroesHealth[needHeal] +=heal;
            if (heroesHealth[needHeal] > 100) {
                heroesHealth[needHeal] = 100;
            }
            System.out.println("Medic healed " + heroesAttackType[needHeal]
                    + " for " + heal);
        }
    }
